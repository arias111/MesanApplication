...
public extension Grid {
    /// Значение минимального размера сетки по-умолчанию 4
    ...
    static var wigthSize: CGFloat { return 280 }
    
    static var mySize: CGFloat { return 60 }
...
public extension CGSize {
    ...
    /// - Parameters:
    ///   - lhs: исходная структура CGSize
    ///   - rhs: другая структура CGSize
    /// - Returns: результат суммирования всех размеров
